...
// frappe.query_reports["Free Stock"] = {
...
//         },
//         {
//             fieldname: "negative_free_stock",
//             label: "Negative Free Stock",
//             fieldtype: "Check",
//             default: 0
//         }
//     ],
...
//                 onclick="frappe.query_reports['Free Stock'].show_so('${data.item_code}')">
//                 ${data.pending_so}
//             </a>`;
//         }
...
//                 onclick="frappe.query_reports['Free Stock'].show_po('${data.item_code}')">
//                 ${data.pending_po}
//             </a>`;
//         }
...
//                 onclick="frappe.query_reports['Free Stock'].show_in_transit('${data.item_code}')">
//                 ${data.in_transit}
//             </a>`;
//         }

//         if (column.fieldname === "free_stock" && data.free_stock < 0) {
//             value = `<span style="color:#e74c3c;font-weight:bold">${data.free_stock}</span>`;
//         }
...
//         frappe.call({
//             method: "sanc_report.sanc_report.report.free_stock.free_stock.get_so_details",
...
//         frappe.call({
//             method: "sanc_report.sanc_report.report.free_stock.free_stock.get_po_details",
//             args: { item_code: item_code },
//             callback: function(r) {
...
//         frappe.call({
//             method: "sanc_report.sanc_report.report.free_stock.free_stock.get_kpis",
...
frappe.query_reports["Free Stock"] = {
    ...
    onload: function(report) {
        ...
        report.page.add_inner_button("Generate Report", function() {
            report.refresh();
        });
    },
